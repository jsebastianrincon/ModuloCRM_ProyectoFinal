...
mysqli_select_db($connexion, 'crmpry') or die("No se encuentra la Base de 
 datos");
$instruccion_SQL = "INSERT INTO reuniones (nombre_reunion,id_usuario,fecha_reunion,hora_reunion,asignado_reunion,descripcion_reunion,estado_reunion) VALUES ('$nombre_reunion','$id_usuario','$fecha_reunion','$hora_reunion','$asignado_reunion','$descripcion_reunion','$estado_reunion')";
