                    ...
                    <fieldset>
                      ...
                      <div class="card-header py-3">
                        ...
                        while ($mostrar = mysqli_fetch_array($result)) {
                          ...
                          echo "<br>";
                          echo "<br>";
                          echo " <a href='registrarusuario?id=$mostrar[id_lead]'><button type='button' class='btn btn-sm btn-success'><i class='fas fa-user-lock'></i>Asignar Credenciales</button></a>";
                        }
                        ?>
                        <br>
                        <br>
